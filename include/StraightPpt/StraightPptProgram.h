...
#include "StraightPptApplication.h"
#include "StraightPptDispatchDriver.h"

namespace STRAIGHTPPT {
/**
 * @brief Represents Ppt program.
 */
class PptProgram {
private:
    /**
     * @brief Return the clsid of Ppt.
...
public:
    /**
     * @brief Starts a Ppt application.
     ...
     */
    static HRESULT start(PptApplication& des);

    /**
     * @brief Connects to a running Ppt application.
     ...
     */
    static HRESULT conn(PptApplication& des);
};
